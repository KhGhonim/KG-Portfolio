...
export default function page() {
  ...
  const project = projects.find((project) => project.category === service);
    ...
    <div>
        ...
        <div className="flex flex-row max-md:flex-col-reverse items-center justify-between gap-8  md:gap-2  w-full p-4">
          ...
          <div className="w-full md:w-1/2">
            {animationData ? (
              ...
              <p>No animation available for this service.</p> // Optional: Display a message if no animation is found
            )}
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen container mx-auto border-r-2 border-l-2 border-black max-md:mt-52  p-6 md:p-12 text-center relative z-30">
        <div className="max-w-7xl mx-auto">
          <h1 id="projects" className="text-4xl md:text-7xl font-bold mb-4">{service}</h1>
