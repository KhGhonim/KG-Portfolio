...
export default function ServicesHome() {
  return (
    <div className="w-screen container mx-auto relative z-20 max-md:pt-44 pb-32 max-md:pb-16  md:border-r-2 md:border-l-2  border-black ">
      {/* Desktop Services */}
      <div className="hidden md:flex flex-col md:flex-row items-center p-6 ">
        ...
        <div className="w-1/3 text-center flex flex-col gap-5">
          ...
          <div className="flex  max-sm:flex-col gap-5 max-md:w-[100%]">
            ...
            <Link className="relative flex justify-center items-center text-center shadow-[9px_5px_0px_1px_rgba(0,0,0,1)] hover:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)] transition-all duration-500  uppercase font-semibold   text-sm sm:text-base  text-black bg-gray-100 border md:border-2 border-black" href={"/Services"}>
      ...
      <div className="hidden max-md:flex flex-col  items-center p-6 ">
        ...
        <div className="flex  max-sm:flex-col gap-5 max-md:w-[100%]">
          ...
          <Link className="relative shadow-[9px_5px_0px_1px_rgba(0,0,0,1)] hover:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)] transition-all duration-500  uppercase font-semibold p-2  text-sm sm:text-base  text-black bg-gray-100 border md:border-2 text-center border-black" href={"/Services"}>
            Read More about SERVICES
          </Link>
        </div>
      </div>
